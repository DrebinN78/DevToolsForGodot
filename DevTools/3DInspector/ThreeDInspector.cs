...
{
    public partial class ThreeDInspector : DevTool, IDevToolInfo
    {
        public string toolname { get => "3D Inspector"; }
        public string tooltip { get => "Examine 3D models, UV coordinates, LOD cascades, etc ..."; }
